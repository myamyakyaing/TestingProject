...
import com.example.realproject.adapters.RecyclerCourseDetailAdapter
...
class CourseDetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var rvCourseDetailAdapter: RecyclerCourseDetailAdapter =
            RecyclerCourseDetailAdapter(
                this,
                R.layout.rv_detail_course,
                title
            )
